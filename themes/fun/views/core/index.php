        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <?php foreach ($character->attributes as $attributeName => $value) : ?>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <strong><?php echo $attributeName ?></strong>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <?php echo $value ?>
                                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <?php if (!empty($character->implants)) { ?>
                                <?php foreach ($character->implants as $implant) : ?>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <?php echo CHtml::image($implant->image(32), $implant->implantName) ?>
                                        <?php echo $implant->implantName ?>
                                    </div>
                                <?php endforeach; ?>
                            <?php } else { ?>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
